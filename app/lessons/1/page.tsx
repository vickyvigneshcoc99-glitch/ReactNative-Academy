        ...
        <main className="min-h-screen py-20 px-6 relative overflow-hidden">
            ...
            >
                ...
                <div className="flex justify-between items-center mt-20">
                    <Link href="/" className="px-10 py-5 glass rounded-2xl font-bold text-[var(--text-primary)] hover:bg-white/10 transition-all">← Back to Home</Link>
                    <Link href="/lessons/2" className="px-10 py-5 bg-gradient-to-r from-[#61dafb] to-[#764abc] rounded-2xl font-bold text-white hover:scale-105 transition-all">Next Lesson →</Link>
                </div>
            </motion.div>
        </main>
    );
