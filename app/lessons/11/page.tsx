            ...
            >
                ...
                <motion.section className="mb-20" variants={{ visible: { opacity: 1, y: 0 }, hidden: itemVariants }}>
                    <div className="glass rounded-3xl p-12 text-center relative overflow-hidden group">
                        ...
                        <Link
                            href="/playground"
                            className="inline-block px-12 py-5 bg-gradient-to-r from-[#f76b1c] to-[#764abc] rounded-xl font-bold text-xl text-white shadow-2xl hover:shadow-[0_0_50px_rgba(247,107,28,0.5)] hover:scale-105 transition-all relative z-10"
                        >
                            Open Playground
                        </Link>
                    </div>
                ...
                <div className="flex justify-between items-center mt-20">
                    <Link href="/lessons/10" className="px-10 py-5 glass rounded-2xl font-bold text-[var(--text-primary)] hover:bg-white/10 transition-all">← Lesson 10</Link>
                    <Link href="/lessons/12" className="px-10 py-5 bg-gradient-to-r from-[#f76b1c] to-[#f59e0b] rounded-2xl font-bold text-white hover:scale-105 transition-all">Final Lesson →</Link>
                </div>
            </motion.div>
        </main>
    );
