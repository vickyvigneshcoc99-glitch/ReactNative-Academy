        ...
        <main className="min-h-screen py-20 px-6 relative overflow-hidden">
            ...
            >
                ...
                <motion.div className="flex flex-col items-center gap-8 mt-20" variants={{ visible: { opacity: 1, y: 0 }, hidden: itemVariants }}>
                    <h2 className="text-4xl font-black text-center">Course Complete! 🎉</h2>
                    <p className="text-xl text-[var(--text-secondary)] text-center max-w-2xl">
                    ...
                    <div className="flex gap-6 relative z-10">
                        <Link href="/lessons/11" className="px-10 py-5 glass rounded-2xl font-bold text-[var(--text-primary)] hover:bg-white/10 transition-all">← Lesson 11</Link>
                        <Link href="/lessons/13" className="px-10 py-5 glass border-[#61dafb]/30 rounded-2xl font-bold text-[var(--text-primary)] hover:bg-white/10 transition-all">Next Lesson: Security →</Link>
                    </div>
                </motion.div>
            </motion.div>
        </main>
