            ...
            >
                ...
                <motion.section className="mb-20" variants={{ visible: { opacity: 1, y: 0 }, hidden: itemVariants }}>
                    <div className="glass rounded-3xl p-12 text-center relative overflow-hidden group">
                        ...
                        <Link href="/playground" className="inline-block px-12 py-5 bg-gradient-to-r from-[#10b981] to-[#3b82f6] rounded-xl font-bold text-xl text-white shadow-2xl hover:shadow-[0_0_50px_rgba(16,185,129,0.5)] hover:scale-105 transition-all relative z-10">
                            Open Playground
                        </Link>
                    </div>
                </motion.section>
                ...
                <div className="flex justify-between items-center mt-20">
                    <Link href="/lessons/3" className="px-10 py-5 glass rounded-2xl font-bold text-[var(--text-primary)] hover:bg-white/10 transition-all">← Lesson 3</Link>
                    <Link href="/lessons/5" className="px-10 py-5 bg-gradient-to-r from-[#10b981] to-[#3b82f6] rounded-2xl font-bold text-white hover:scale-105 transition-all">Next Lesson →</Link>
                </div>
            </motion.div>
        </main>
    );
