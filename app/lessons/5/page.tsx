        ...
        <main className="min-h-screen py-20 px-6 relative overflow-hidden">
            ...
            >
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-between items-center mt-20">
                    <Link href="/lessons/4" className="w-full sm:w-auto text-center px-10 py-5 glass rounded-2xl font-bold text-[var(--text-primary)] hover:bg-white/10 transition-all">← Lesson 4</Link>
                    <Link href="/lessons/6" className="w-full sm:w-auto text-center px-10 py-5 bg-gradient-to-r from-[#764abc] to-[#61dafb] rounded-2xl font-bold text-white hover:scale-105 transition-all">Next Lesson →</Link>
                </div>
            </motion.div>
        </main>
    );
