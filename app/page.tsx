...
export default function Home() {
  const fadeInUp = {
    ...
    visible: (custom: number) => ({
      opacity: 1,
      y: 0,
      transition: { delay: custom, duration: 1, ease: [0.22, 1, 0.36, 1] }
    })
  };
  ...
  return (
    <main className="min-h-screen">
      ...
      <section className="relative min-h-screen flex items-center justify-center px-4 md:px-6 py-20 overflow-hidden">
        ...
        <div className="relative z-10 max-w-6xl mx-auto text-center">
          ...
          >
            <Link
              href="/lessons/1"
              className="w-full sm:w-auto px-8 py-4 bg-gradient-to-r from-[#61dafb] to-[#764abc] rounded-xl font-bold text-lg text-white shadow-lg hover:shadow-2xl hover:scale-105 transition-all duration-300 overflow-hidden text-center group relative"
            >
            ...
            <Link
              href="/playground"
              className="w-full sm:w-auto px-8 py-4 glass rounded-xl font-bold text-lg text-[var(--text-primary)] hover:bg-white/10 transition-all duration-300 hover:scale-105 text-center"
            >
              Try Playground
            </Link>
            ...
            <a
              ...
              className="w-full sm:w-auto flex items-center justify-center gap-2 px-8 py-4 glass rounded-xl font-bold text-lg text-[var(--text-primary)] hover:bg-white/10 transition-all duration-300 hover:scale-105 border border-white/10"
            >
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-black mb-4">
              <span className="bg-gradient-to-r from-[#61dafb] to-[#764abc] bg-clip-text text-transparent uppercase tracking-tight">
      ...
      <section className="py-20 px-4 md:px-6 bg-gradient-to-b from-transparent to-[var(--bg-secondary)]">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-black mb-4">
              <span className="bg-gradient-to-r from-[#764abc] to-[#f76b1c] bg-clip-text text-transparent uppercase tracking-tight">
                Flexbox Differences
              </span>
            </h2>
            <p className="text-xl text-[var(--text-secondary)] max-w-2xl mx-auto">
      ...
      <section className="py-20 px-4 md:px-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-black mb-4">
              <span className="bg-gradient-to-r from-[#f76b1c] to-[#10b981] bg-clip-text text-transparent uppercase tracking-tight">
                Learning Path
              </span>
            </h2>
            <p className="text-xl text-[var(--text-secondary)] max-w-2xl mx-auto">
      ...
      <section className="py-20 px-4 md:px-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-black mb-4">
              <span className="bg-gradient-to-r from-[#10b981] via-[#61dafb] to-[#764abc] bg-clip-text text-transparent uppercase tracking-tight">
                Developer Showcase
              </span>
            </h2>
            <p className="text-xl text-[var(--text-secondary)] max-w-2xl mx-auto">
      ...
      <section className="py-32 px-4 md:px-6">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl sm:text-5xl md:text-6xl font-black mb-6 leading-tight uppercase tracking-tight">
            Ready to Build <br />
            <span className="bg-gradient-to-r from-[#61dafb] via-[#764abc] to-[#f76b1c] bg-clip-text text-transparent">
              Native Mobile Apps?
            </span>
          ...
          <Link
            href="/lessons/1"
            className="w-full sm:w-auto inline-block px-12 py-5 bg-gradient-to-r from-[#61dafb] to-[#764abc] rounded-xl font-bold text-xl text-white shadow-2xl hover:shadow-[0_0_50px_rgba(97,218,251,0.5)] hover:scale-105 transition-all duration-300"
          >
            Begin Lesson 1
          </Link>
        </div>
